...
export class HMAC {
    ...
    constructor(key: Uint8Array) {
        ...
        this.inner._saveState(<any>this.istate);
        this.outer._saveState(<any>this.ostate);
    ...
    reset(): this {
        this.inner._restoreState(<any>this.istate, this.inner.blockSize);
        this.outer._restoreState(<any>this.ostate, this.outer.blockSize);
        return this;
    }
